...
from api.routes import system, activity, assistant, collections, items
...
router.include_router(items.router, prefix="/collections/{collection_id}/items", tags=["items"])
